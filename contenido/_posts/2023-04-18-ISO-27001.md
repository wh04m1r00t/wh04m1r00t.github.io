...
1. **Acciones para abordar riesgos y oportunidades:**
    ...
    a. Generalidades: Al planificar el sistema de gestión de la seguridad de la información la organización debe tener en cuenta que debemos [entender la organización y su contexto][ORGYCONT] y [comprender las necesidades y expectativas de las partes interesadas][COMNEPI]
