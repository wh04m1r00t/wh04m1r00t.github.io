...
image: 
  path: \assets\img\ISO27001\CBT.jpg
description: >
...
2. **Objetivos de seguridad de la información y planificación para lograrlos:** La organización establece objetivos de seguridad de información en los niveles y funciones correspondientes. Además los objetivos de seguridad de la información deben ser coherentes con la política de seguridad, medibles, considerar los requisitos de seguridad y riesgos, ser monitoreados y comunicados, actualizarse y estar documentados.

    Al planificar la consecución de los objetivos de seguridad de la información, la organización debe determinar qué hacer, qué recursos necesitará, quién será responsable, cuándo se completará y cómo se evaluarán los resultados.

3. **Planificación de cambios:** Los cambios en el sistema de gestión de la seguridad de la información deben planificarse antes de llevarse a cabo.

#  Soporte

1. **Recursos:** La organización debe proveer los recursos necesarios para establecer, implementar, mantener y mejorar continuamente el sistema de gestión de seguridad de la información.

2. **Competencia:** la organización deberá:

    a. Determinar la competencia necesaria para el personal que afecta el desempeño en seguridad de la información.

    b. Garantizar que el personal sea competente a través de educación, formación o experiencia adecuadas.

    c. Tomar acciones para adquirir la competencia necesaria si es necesario.

    d. Evaluar la efectividad de las acciones tomadas.

    e. Conservar información documentada como evidencia de competencia.

3. **Conciencia:** las personas que participen en la organización deberán tener conciencia sobre:

    a. La política de seguridad de la información.

    b. Su contribución a la eficacia del SGSI y beneficios del mejor desempeño de la seguridad de la información.

    c. Implicaciones de incumplimiento de los requisitos del SGSI

4. **Comunicación:** La organización debe determinar la necesidad de comunicaciones internas y externas relevantes para el SGSI, incluyendo qué, cuándo, con quién y cómo comunicar.

5. **Información documentada:**

    a. Generalidades: El SGSI de la organización debe incluir.

      1. información documentada.

      2. Información necesaria para la eficacia del sistema de gestión de la seguridad de la información.

      3. Información necesaria para la seguridad de la información, que varía según el tamaño, actividades, complejidad y competencia de la organización.

    b. Creación y actualización: Al crear y actualizar documentos, la organización debe asegurar que se identifique y describa claramente el contenido, se establezcan el formato y soporte adecuados, y se revise y apruebe su idoneidad y adecuación.

    c. Control de la información documentada: La información documentada del sistema de gestión de seguridad de la información se controla para asegurar su disponibilidad y protección. La organización debe abordar actividades como distribución, acceso, almacenamiento, control de cambios, retención y disposición de la información documentada.

# Operación

1. **Planificación y control operativo:** La organización debe planificar, implementar y controlar procesos, estableciendo criterios y controlando la documentación para cumplir requisitos. Controlar cambios, mitigar efectos adversos, y garantizar control de procesos externos relevantes.

2. **Evaluación de riesgos de seguridad de la información:** La organización debe evaluar los riesgos de seguridad de la información de manera regular y cuando se produzcan cambios importantes. También debe guardar registros de los resultados de estas evaluaciones. 

3. **Tratamiento de riesgos de seguridad de la información:** La organización debe aplicar el plan de tratamiento de riesgos de seguridad de la información y documentar los resultados.

# Evaluación del desempeño

1. **Seguimiento, medición, análisis y evaluación:** La organización debe determinar:

    a. qué procesos y controles de seguridad de la información se deben monitorear y medir

    b. los métodos para garantizar la validez de los resultados.

    c. cuándo realizar el seguimiento y la medición.

    d. quién será responsable de monitorear y medir.

    e. cuándo se analizarán y evaluarán los resultados.

    f. quién analizará y evaluará los resultados.

2.  **Auditoría interna:** 

    a. Generalidades: La organización debe hacer auditorías internas planeadas para verificar si su sistema de gestión de seguridad de la información cumple con los requisitos propios y los establecidos, y si se implementa y mantiene de manera efectiva.

    b. Programa de auditoría interna: La organización debe establecer y mantener programas de auditoría interna, considerando la importancia de los procesos y resultados previos, y definiendo criterios y alcance de cada auditoría, seleccionando auditores objetivos e imparciales. Los resultados deben informarse a la dirección pertinente y mantenerse documentados.

3. **Revisión por la dirección:**

    a. Entradas de la revisión por la dirección: En la revisión por la dirección se considerarán: el estado de revisiones anteriores, cambios externos e internos, necesidades y expectativas de partes interesadas, retroalimentación sobre desempeño, resultados de monitoreo y medición, no conformidades y acciones correctivas, retroalimentación de partes interesadas, evaluación de riesgos, estado del plan de tratamiento de riesgos y oportunidades de mejora continua.

# Mejora

1. **Mejora continua:** La organización debe mejorar continuamente su sistema de gestión de la seguridad de la información.

2. **No conformidad y acción correctiva:** Ante una no conformidad, la organización debe reaccionar y tomar medidas para controlar y corregir el problema, evaluar las causas, implementar las acciones necesarias, revisar su efectividad y hacer cambios en el sistema de gestión de la seguridad de la información si es necesario. Las acciones correctivas deben ser apropiadas y la información documentada disponible como evidencia.

# Anexo A

Se realiza una referencia directa a los controles de la ISO 27002.
