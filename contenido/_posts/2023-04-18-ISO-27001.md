...
1. **Entender la organización y su contexto:**  Identificar los factores internos y externos relevantes que afecten el sistema de gestión de seguridad de la información.{:toc}


2. **Comprender las necesidades y expectativas de las partes interesadas:** Identificar partes interesadas y sus requisitos pertinentes para el sistema de gestión de seguridad de la información.{:toc}

3. **Determinación del alcance del sistema de gestión de seguridad de la información:** Definir el alcance del sistema de gestión de seguridad de la información es responsabilidad de la organización.{:toc}

4. **Sistema de gestión de seguridad de la información:** La organización debe desarrollar, aplicar, mantener y mejorar un sistema de gestión de seguridad de la información, conforme a lo establecido en esta normativa.{:toc}
